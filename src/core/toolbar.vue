    ...
    <div class="box-right flex align-center pl-10">
      <el-dropdown trigger="click" @command="onCommandLang">
        <span class="el-dropdown-link">
          <i class="flag-icon" :class="{['flag-icon-'+(interfaceLanguage==='en'?'us':'cn')]:true}"></i>
        </span>
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="en">
            <i class="flag-icon flag-icon-us mr-15"></i>English</el-dropdown-item>
          <el-dropdown-item command="zh">
            <i class="flag-icon flag-icon-cn mr-15"></i>Chinese</el-dropdown-item>
          <!-- <el-dropdown-item command="it">
            
            <i class="flag-icon flag-icon-it mr-15"></i>Italian</el-dropdown-item>
          <el-dropdown-item command="fr">
            <i class="flag-icon flag-icon-fr mr-15"></i>French</el-dropdown-item>
          <el-dropdown-item command="de">
            <i class="flag-icon flag-icon-de mr-15"></i>German</el-dropdown-item>
          <el-dropdown-item command="es">
            <i class="flag-icon flag-icon-es mr-15"></i>Spanish</el-dropdown-item>
          <el-dropdown-item command="cn">
            <i class="flag-icon flag-icon-cn mr-15"></i>Chinese</el-dropdown-item>
          <el-dropdown-item command="jp">
            <i class="flag-icon flag-icon-jp mr-15"></i>Japanese</el-dropdown-item>
          <el-dropdown-item command="/multi-language">
            <i class="mdi mdi-translate mr-15"></i>Read the docs</el-dropdown-item> -->
        </el-dropdown-menu>
      </el-dropdown>
      ...
      <!-- <el-badge :is-dot="true" class="notification-icon-badge">
        <el-button @click="toUrl('/message-box')" icon="mdi mdi-bell" class="notification-icon"></el-button>
      </el-badge> -->
      <span class="username">
      ...
      <el-dropdown trigger="click" @command="onCommand">
        ...
        <el-dropdown-menu slot="dropdown">
          <!-- <el-dropdown-item command="/profile">
            <i class="mdi mdi-account mr-10"></i> Profile</el-dropdown-item>
          <el-dropdown-item command="/calendar">
            <i class="mdi mdi-calendar mr-10"></i> Calendar</el-dropdown-item>
          <el-dropdown-item command="/contacts">
            <i class="mdi mdi-account-multiple mr-10"></i> Contacts</el-dropdown-item> -->
          <el-dropdown-item command="/logout" divided>
            <i class="mdi mdi-logout mr-10"></i> Logout</el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    onCommandLang(lang) {
      ...
      // else this.lang = lang;
      this.$store.dispatch("setInterfaceLanguage", lang);
